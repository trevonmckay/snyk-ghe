...
namespace SnykGhe.WebhookService.Webhooks
{
    /// <summary>
    /// Single dispatch point for every webhook delivery (signature already validated in the controller):
    /// pull request events queue scans; installation events maintain the registry.
    /// </summary>
